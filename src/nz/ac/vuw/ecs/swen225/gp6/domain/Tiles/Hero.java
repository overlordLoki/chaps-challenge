...
public class Hero extends Actor {
  ...
  public Tile replaceWith() {
    return this;
  } //to know if a hero is taken by other tiles such as enemy

  @Override
  public void setOn(Tile t, Domain d) {
    if (t == null || d == null) {
      throw new NullPointerException("Domain d and Tile t must not be null(Hero.setOn)");
    }
  ...
  public void ping(Domain d) {
    if (d == null) {
      throw new NullPointerException("Domain d can not be null(Hero.ping)");
    }
    ...
    if (dir == Direction.None || tileToOccupy.obstructsHero(d)) {
      return;
    }
