...
public class Tile {
    ...
    /**
     * Checks wether this tile is an obstruction for another given tile t, in a given maze.
    ...
    /**
     * Sets the given tile t instead this tile on maze, changing the maze to do so.
