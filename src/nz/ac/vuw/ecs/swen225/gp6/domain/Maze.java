...
public class Maze {
  ...
  private final int height; //height of tile array, how many rows (outer array)
  private final int width;  //width of tile array, how many columns (inner arrays)
  ...
  public Loc getTileLoc(Tile t) {
    if (t == null) {
      throw new NullPointerException("tile t cannot be null Maze.getTileLoc(Tile)");
    }
   ...
   *
   * @param d - domain where the ping is taking place in (this is since the ping may affect
   *          inventory, level index, etc)
   * @throws NullPointerException if Domain is null
   */
  public void pingMaze(Domain d) {
    if (d == null) {
      throw new NullPointerException("domain cannot be null in maze.pingMaze()");
    }
  ...
  public void setTileAt(Loc loc, Tile tile) {
    //prechecks
    if (tile == null) {
      throw new IllegalArgumentException("Tile cannot be null (Maze.setTileAt(Loc, Tile))");
    }
    checkLocationIntegrity(loc);
  ...
  public void checkLocationIntegrity(Loc loc) {
    if (loc == null) {
      throw new NullPointerException(
          "location cannot be null in (Maze.checkLocationIntegrity(Loc))");
    }
    if (!Loc.checkInBound(loc, this)) {
