...
/**
 * Tests that test the Domain package, through moving the player as
 * as the user would.
 *
...
public class DomainTestsThruMoves {
  ...
  /**
   * given a maze string as input, and another as output, and a sequence of moves, it checks wether
   * after applying these moves on the input maze the a maze equivalent to the output maze is
   * reached.
   *
  ...
  /**
   * tests if a given input and a given sequence of moves results in a generic exception, and a
   * final maze equivalent to the input.(CURRENTLY NOT USED but kept due to intense usefulness)
   *
   * @param input     a string representing initial maze
   * @param moves     a string representing sequence of moves
   * @param output    a string representing expected final maze
   ...
   */
  public static void testHarnessInvalid(String input, String moves, String output,
  ...
  /**
   * makes tile object from given character, with given info (e.g location x and y)
   *
  ...
  /**
   * does a sequence of moves on a given maze.
   * moves are given as a string of characters (U, D, L, R) separated by space.
   *
  ...
  /**
   * parses a specific format of string into a maze object.
   *
   * @param maze string format of the maze
